...
function renderCard(user, isLiked, myUser, isMatch) {
  ...
  return `
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-2 hover:border-indigo-200 hover:shadow-md overflow-hidden flex flex-col transition-all duration-200 hover:shadow-xl hover:-translate-y-1"
